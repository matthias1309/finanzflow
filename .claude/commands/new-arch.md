...
Use ASCII diagrams or Mermaid blocks where helpful. Link to the relevant sections of
`docs/architecture/ARC42.md` instead of duplicating system-level content.>
...
8. If the design adds routes, tables, components, runtime flows or decisions, update `docs/architecture/ARC42.md` (update table in `.claude/rules/v-model.md`).
9. Tell the user:
