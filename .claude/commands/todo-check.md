...
Run this command:
```
grep -rn --include="*.ts" --include="*.tsx" --include="*.js" --include="*.jsx" --exclude-dir=node_modules --exclude-dir=.git --exclude-dir=dist -E "(TODO|FIXME|HACK|XXX|TEMP|NOCOMMIT)(\(.*\))?:" client server shared script tests
```
