...
**Status:** Active development on the V-Model template (migration completed 2026-09-24, see
`docs/MIGRATION-PLAN.md` for the history and the open follow-ups)
...
docs/
  ...
  SYSTEM-MAP.md         # horizontal REQ/ARCH relationship map (generated by /system-map)
  MIGRATION-PLAN.md     # template migration (completed): decisions, session log, follow-ups
