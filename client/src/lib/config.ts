 ...
 * Läuft die App unter einem Unterpfad, wird VITE_API_BASE beim Build gesetzt.
 * In der lokalen Entwicklung und im Raspberry-Pi-Docker-Deployment (Root-Pfad)
 * bleibt API_BASE leer (relativer Pfad).
 */
